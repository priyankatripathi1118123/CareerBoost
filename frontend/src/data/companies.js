export const companiesData = [
    {
        ...
        "selection_process": [
            "Online Assessment (Aptitude & Logical)",
        ...
        "interview_rounds": [
            {
                "round": "Online Test",
                "details": "Focuses on quantitative aptitude, logical reasoning, and verbal ability. Time management is crucial here."
            },
            {
                "round": "Technical Round",
                "details": "Questions revolve around OOPs, DBMS, SQL, and the candidate's resume/projects."
            },
            {
                "round": "HR Round",
                "details": "Standard behavioral questions evaluating culture fit, flexibility to relocate, and communication skills."
            }
        ],
        "hr_questions": [
            ...
            "Explain a time you faced a challenge.",
            "How do you handle pressure?",
            "What do you know about our CEO?",
            "Describe your final year project.",
            "Why should we hire you?",
            "Are you flexible with night shifts?",
        ...
        "tech_questions": [
            ...
            "How do you reverse a string without using inbuilt functions?",
            "Explain your role in your listed projects."
        ],
        "aptitude_topics": [
            "Percentage",
            "Profit & Loss",
    ...
    },
    {
        ...
        "selection_process": [
            ...
            "System Design / Hiring Manager Round"
        ],
        "interview_rounds": [
            {
                "round": "Online Coding",
                "details": "2-3 medium to hard Data Structures & Algorithms questions on platforms like Codility."
            },
            {
                "round": "Technical Rounds",
                "details": "Deep dive into problem-solving, Trees, Graphs, Dynamic Programming, and code optimization."
            },
            {
                "round": "AA/As-App Round",
                "details": "The 'As Appropriate' round focuses on system design (for experienced) and core cultural fit principles."
            }
        ],
        "hr_questions": [
            ...
            "How do you ensure your code is secure and accessible?",
        ...
        "tech_questions": [
            ...
            "Write code to perform a level-order traversal of a tree.",
        ...
        "interview_rounds": [
            {
                ...
                "details": "Coding questions (usually 2) plus a behavioral/work-style assessment."
            },
            {
                "round": "Technical Rounds",
                "details": "Focus on DSA, particularly trees, graphs, and hash maps. Must write production-quality code on a whiteboard/document."
            },
            {
                "round": "Bar Raiser",
                "details": "Evaluates if the candidate raises the average bar of the team. Heavy focus on Amazon's 16 Leadership Principles."
            }
        ],
        "hr_questions": [
            "Tell me about a time you took a calculated risk.",
            "Describe a situation where you 'Disagreed and Committed'.",
            "Tell me about a time you invented a simpler solution.",
            "How do you handle tight deadlines?",
            "Give an example of when you had to dive deep into a problem.",
            "Tell me about a time you failed to meet expectations.",
            "Describe a time you received critical feedback.",
            "How do you earn trust in a new team?",
            "Tell me about a time you showed customer obsession.",
            "Describe a time you had to make a decision without all the data.",
            "Give an example of thinking big.",
            "Tell me about a time you had to deal with an underperforming teammate.",
            "How do you prioritize customer needs?",
            "Describe a time you delivered results despite roadblocks.",
            "Why Amazon?"
        ],
        "tech_questions": [
            "Two Sum problem.",
            ...
            "How does AWS S3 ensure high availability?",
    ...
    },
    {
        ...
        "interview_rounds": [
            {
                "round": "Cognitive & Tech Test",
                "details": "Aptitude, logical reasoning, english ability, and pseudocode/networking basics."
            },
            {
                "round": "Coding Test",
                "details": "2 coding questions, usually fundamental level (Arrays, Strings)."
            },
            {
                "round": "Interview",
                "details": "A combined technical and HR round. Focuses heavily on your final year project and basic HR questions."
            }
        ],
        "hr_questions": [
            "Tell me about yourself.",
            "Why Accenture?",
            "What do you know about our core values?",
            "Where do you see yourself in 3 years?",
            "Are you comfortable working across different domains?",
            ...
            "Are you willing to relocate?",
            "Are you okay with working in shifts?",
        ...
        "tech_questions": [
            ...
            "Explain the basics of HTML/CSS.",
            "What is an API?",
            "Difference between array and linked list.",
            "What is polymorphism?",
            "How do you handle exceptions in Java/Python?",
            "What is a primary key?",
            "Explain your role in your project.",
    ...
    },
    {
        ...
        "interview_rounds": [
            {
                "round": "Phone Screen",
                "details": "A 45-minute Google Meet interview focusing purely on DSA and algorithmic problem solving."
            },
            {
                "round": "Onsite Technical",
                "details": "4 rounds of intense DSA, graph theory, DP, and system design (for senior roles)."
            },
            {
                "round": "Googleyness (Behavioral)",
                "details": "Evaluates how you navigate ambiguity, work in teams, and fit into Google's culture."
            }
        ],
        "hr_questions": [
            ...
            "What is the most difficult technical challenge you've faced?",
            ...
            "How do you balance perfection with deadlines?",
        ...
        "tech_questions": [
            ...
            "Explain MapReduce.",
            "How would you design a type-ahead search feature?",
            "Find the kth largest element in an array.",
            "Merge intervals.",
            "Explain Paxos or Raft consensus algorithms.",
    ...
    },
    {
        ...
        "interview_rounds": [
            {
                "round": "TCS NQT",
                "details": "Comprises Numerical Ability, Verbal Ability, Reasoning Ability, Programming Logic, and 2 Coding questions."
            },
            {
                "round": "Technical Round",
                "details": "Focuses on basics of C/C++/Java, DBMS, SQL, and final year projects."
            },
            {
                "round": "HR/MR Round",
                "details": "Focuses on Tata ethics, willingness to relocate, bond agreements, and basic behavioral questions."
            }
        ],
        "hr_questions": [
            "Tell me about yourself.",
            "Why do you want to join TCS?",
            "What do you know about the Tata Group?",
    ...
    },
    {
        ...
        "interview_rounds": [
            {
                "round": "Online Assessment",
                "details": "Aptitude (Quant, Logical, Verbal), Written Communication (Essay), and Coding (2 programs)."
            },
            {
                "round": "Technical Round",
                "details": "Focus on Java/C++, SQL queries, basics of Web Technologies, and resume validation."
            },
            {
                "round": "HR Round",
                "details": "General behavioral questions, service agreement discussion, and location preferences."
            }
        ],
        "hr_questions": [
            "Tell me about yourself.",
            "Why Wipro?",
            "What do you know about Azim Premji?",
            "Where do you see yourself in 5 years?",
        ...
        "tech_questions": [
            ...
            "Write a SQL query to find the 3rd highest salary.",
            "What is Agile?",
    ...
    },
    {
        ...
        "interview_rounds": [
            {
                "round": "Online Test",
                "details": "Hosted on AMCAT/Aspiring Minds. Covers Automata Fix (Debugging), Quants, Logical, and English."
            },
            {
                "round": "Technical Round",
                "details": "Focuses heavily on DBMS, SQL, and writing small code snippets during the interview."
            },
            {
                "round": "HR Round",
                "details": "Standard HR questions to assess communication, flexibility, and cultural fit."
            }
        ],
        "hr_questions": [
            "Tell me about yourself.",
    ...
    },
    {
        ...
        "interview_rounds": [
            {
                "round": "Online Assessment",
                "details": "Includes Pseudocode round (very important), English communication, and a unique Game-based aptitude test."
            },
            {
                "round": "Technical Round",
                "details": "Focus on core CS subjects, pseudocode explanation, and project discussion."
            },
            {
                "round": "HR Round",
                "details": "Evaluates communication skills, adaptability, and culture fit."
            }
        ],
        "hr_questions": [
            "Introduce yourself.",
            ...
            "Are you flexible with shift timings?",
            "Do you have any questions for me?"
        ],
        "tech_questions": [
            "Explain the logic behind the pseudocode you wrote in the exam.",
            "What is data abstraction?",
            "Difference between Array and Linked List.",
            "What is a primary key?",
            "Write a SQL query for inner join.",
    ...
    },
    {
        ...
        "interview_rounds": [
            {
                "round": "Online Assessment",
                "details": "Quantitative, Logical, Verbal, and 2 Coding questions (often medium difficulty on arrays/strings)."
            },
            {
                "round": "Versant Test",
                "details": "An automated spoken English test assessing pronunciation, fluency, and sentence mastery."
            },
            {
                "round": "Personal Interview",
                "details": "A combined Tech and HR round. Heavy focus on resume, projects, SQL, and scenario-based behavioral questions."
            }
        ],
        "hr_questions": [
            "Tell me about yourself.",
            "Why Deloitte?",
            "What do you know about the 'Big Four'?",
            ...
            "How do you manage your time under pressure?",
        ...
        "tech_questions": [
            ...
            "Write a complex SQL query using JOIN and GROUP BY.",
            "Explain Object-Oriented Programming concepts.",
            "What is the difference between Abstract Class and Interface?",
            "Explain the concept of Agile.",
            "How do you handle exceptions in code?",
            "What is Cloud Computing? (Basic AWS/Azure concepts)",
